    ...
    ([function(c,g,b){
        ...
        function e(){
            ...
            if(t.tagName==="TEXTAREA"||(t.tagName==="INPUT"&&t.getAttribute("type")==="text")){
                ...
                return{
                    x:u.left+v.left,y:u.top+v.top,color:m(t)
                }
            }
        ...
        function h(q,s,r){
            return{
                x:q,y:s,alpha:1,color:r,velocity:{
        ...
        function o(){
            ...
            while(s--){
                n[j]=h(t.x,t.y,t.color);j=(j+1)%500
            }
            f=k;
            if(!p){
            ...
            if(o.shake){
                ...
                document.body.style.marginLeft=q+"px";document.body.style.marginTop=u+"px";
                setTimeout(function(){
        ...
        function i(){
            ...
            for(var q=0;q<n.length;++q){
                ...
                r.velocity.y+=0.075;
                r.x+=r.velocity.x;
                r.y+=r.velocity.y;r.alpha*=0.96;
                a.globalAlpha=r.alpha;a.fillStyle=r.color;
    ...
    function(b,a){
        (function(){
            ...
            function c(k,l,o){
                ...
                var g=f.style;
                var j=window.getComputedStyle?getComputedStyle(k):k.currentStyle;g.whiteSpace="pre-wrap";
                if(k.nodeName!=="INPUT"){
                ...
                f.appendChild(n);
                var m={top:n.offsetTop+parseInt(j["borderTopWidth"]),left:n.offsetLeft+parseInt(j["borderLeftWidth"])
                };
